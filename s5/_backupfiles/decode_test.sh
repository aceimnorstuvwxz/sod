...
#[dgk]the version of not JOBed, and not PIPEed with nnet-forward and latgen-faster-mapped,
#test experiment for latgen-faster-mapped-daemon which is daemon style.
...
feats="ark,s,cs:copy-feats scp:$sdata/1/feats.scp ark:- |"
# apply-cmvn (optional),
[ ! -z "$cmvn_opts" -a ! -f $sdata/1/cmvn.scp ] && echo "$0: Missing $sdata/1/cmvn.scp" && exit 1
[ ! -z "$cmvn_opts" ] && feats="$feats apply-cmvn $cmvn_opts --utt2spk=ark:$sdata/1/utt2spk scp:$sdata/1/cmvn.scp ark:- ark:- |"
# add-deltas (optional),
...
copy-feats scp:$sdata/1/feats.scp ark:- | \
apply-cmvn --norm-means=true --norm-vars=false --utt2spk=ark:$sdata/1/utt2spk scp:$sdata/1/cmvn.scp ark:- ark:$dir/feats.ar


    ./nnet-forward-daemon-api.py  "ark,s,cs:$dir/feats.ar" "ark:$dir/netout.1.ar" 
